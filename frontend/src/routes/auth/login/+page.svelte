...
<svelte:head>
	<title>Sign In - Creative AI Studio</title>
</svelte:head>

<main class="min-h-screen bg-bg-primary flex items-center justify-center px-4">
	<div class="w-full max-w-md">
		<div class="card">
			<!-- Header -->
			<div class="text-center mb-8">
				<h1 class="text-2xl font-bold text-text-primary">Welcome Back</h1>
				<p class="text-text-secondary text-sm mt-2">Sign in to Creative AI Studio</p>
			</div>
			...
			<div class="relative mb-6">
				...
				<div class="relative flex justify-center text-xs">
					<span class="px-2 bg-[var(--bg-card)] text-text-muted">or continue with email</span>
				</div>
			</div>
			...
			<form on:submit|preventDefault={handleSubmit} class="space-y-4">
				...
				<div class="flex items-center justify-between text-sm">
					...
					<a href="/auth/forgot-password" class="text-accent hover:underline">Forgot password?</a>
				</div>
