...
// - POST to configurable BASE_URL (default: https://api.openai.com/v1/images/generations)
// - Supports OPENAI_BASE_URL env var for proxy/custom endpoints
...
// - POST to configurable BASE_URL (default: https://generativelanguage.googleapis.com/v1beta/models)
// - Supports GEMINI_BASE_URL env var for proxy/custom endpoints
// - Appends model name and API key: {BASE_URL}/{model}/samplerInfo?key={key}
...
// - Supports ANTHROPIC_BASE_URL env var for future Claude image generation API
// - Stub: Anthropic does not currently support image generation via API
