...
OPENAI_API_KEY=
OPENAI_BASE_URL=          # Optional: defaults to https://api.openai.com/v1/images/generations
GEMINI_API_KEY=
GEMINI_BASE_URL=          # Optional: defaults to https://generativelanguage.googleapis.com/v1beta/models
ANTHROPIC_API_KEY=
ANTHROPIC_BASE_URL=       # Optional: for future Claude image generation API
```
...
pub struct Config {
    ...
    // Worker-only: AI provider API keys and base URLs
    pub openai_api_key: Option<String>,
    pub openai_base_url: Option<String>,     // Defaults to OpenAI endpoint
    pub gemini_api_key: Option<String>,
    pub gemini_base_url: Option<String>,     // Defaults to Gemini endpoint
    pub anthropic_api_key: Option<String>,
    pub anthropic_base_url: Option<String>,   // For future Claude image API
}
